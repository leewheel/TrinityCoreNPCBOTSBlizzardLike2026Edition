...
-- Crystal zap conditions (chain spells only; 28041 is single-target — handled in script + spell filter)
DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId` = 13 AND `SourceEntry` IN (28032, 28056) AND `SourceGroup` = 1;
