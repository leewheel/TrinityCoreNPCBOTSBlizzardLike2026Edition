...
local btnItems = CreateSubTabButton(subTabBar, 1, "物品"); btnItems:SetPoint("LEFT", 0, 0)
local btnSets = CreateSubTabButton(subTabBar, 2, "套装"); btnSets:SetPoint("LEFT", btnItems, "RIGHT", 0, 0)
local btnForms = CreateSubTabButton(subTabBar, 3, "形态"); btnForms:SetPoint("LEFT", btnSets, "RIGHT", 0, 0)
local btnSpells = CreateSubTabButton(subTabBar, 4, "法术"); btnSpells:SetPoint("LEFT", btnForms, "RIGHT", 0, 0)
