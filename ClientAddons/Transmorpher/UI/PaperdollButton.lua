...
btn:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine("|cffFFD100幻化大师|r")
    GameTooltip:AddLine("打开幻化窗口", 1, 1, 1, true)
    GameTooltip:AddLine(" ", 1, 1, 1, true)
    GameTooltip:AddLine("|cff888888左键点击：|r 打开/关闭窗口", 0.8, 0.8, 0.8)
    GameTooltip:AddLine("|cff888888右键拖拽：|r 移动按钮", 0.8, 0.8, 0.8)
    GameTooltip:Show()
end)
...
DEFAULT_CHAT_FRAME:AddMessage("|cffF5C842⚔ 幻化大师|r v"..ns.VERSION.." 已加载 — |cff00ff00/morph|r 或点击角色模型上的按钮。")
