...
do
    ...
    btn:SetScript("OnClick", function()
        ...
        if didChange then
            SELECTED_CHAT_FRAME:AddMessage("|cffF5C842<幻化>|r：所有槽位已幻化！")
        else
            SELECTED_CHAT_FRAME:AddMessage("|cffF5C842<幻化>|r：没有可应用的。")
        end
    ...
    btn:HookScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("|cffF5C842全部应用|r", 1, 1, 1)
        GameTooltip:AddLine("将所有预览物品作为幻化应用到角色。", 0.7, 0.9, 1, 1, true)
        GameTooltip:Show()
    end)
