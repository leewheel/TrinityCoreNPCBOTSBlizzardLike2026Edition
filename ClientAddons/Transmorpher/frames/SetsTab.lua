...
function ns.InitSetsTab(parent)
    ...
    local function SelectFilter(cls)
        currentFilter = cls
        filterBtnText:SetText("职业: " .. (classDisplayNames[cls] or cls))
    ...
    searchPlaceholder:SetText("搜索套装...")
    ...
    BuildList = function()
        ...
        statsText:SetText("可用套装: " .. #allSets)
    ...
    applyBtn:SetScript("OnClick", function()
        ...
        print("|cffF5C842<幻化>|r: 已应用套装 " .. selectedSet.name)
    end)
