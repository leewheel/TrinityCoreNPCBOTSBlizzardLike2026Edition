...
// By leewheel 20260529 - Visual Studio IntelliSense may parse CUDA-enabled
// ggml headers as plain MSVC while still defining __CUDACC__, which leaves
// __host__/__device__ undefined and causes hundreds of bogus "active errors".
// NVCC defines these normally during real CUDA compilation, so this is IDE-only.
