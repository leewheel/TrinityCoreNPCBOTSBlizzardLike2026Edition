...
# define BOT_WP_LOG_TRACE TC_LOG_TRACE
# define BOT_WP_LOG_DEBUG TC_LOG_DEBUG
# define BOT_WP_LOG_INFO TC_LOG_INFO
# define BOT_WP_LOG_WARN TC_LOG_WARN
# define BOT_WP_LOG_ERROR TC_LOG_ERROR
# define BOT_WP_LOG_FATAL TC_LOG_FATAL
#else
# define BCore Acore
