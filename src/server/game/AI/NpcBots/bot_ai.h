...
public:
    ...
    static void LogWandererBehaviorSampleHeader();
    void LogWandererBehaviorSample() const;
...
private:
    ...
    mutable uint16 _wanderDiagPathFallback{};
    mutable uint16 _wanderDiagTeleportRecover{};
