...
private:
    ...
    static void _loadConfig(bool reload)
    {
        ...
        _wanderingBotsLogSampleIntervalSec = std::max<uint32>(_wanderingBotsLogSampleIntervalSec, 1u);
        _wanderingBotsLogSampleCount = std::max<uint32>(_wanderingBotsLogSampleCount, 1u);
...
uint32 BotCfg::GetWanderingBotsLogSampleIntervalMs()
{
    return _wanderingBotsLogSampleIntervalSec * IN_MILLISECONDS;
}
