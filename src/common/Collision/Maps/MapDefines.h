...
// By leewheel 20260528 - keep IntelliSense-friendly expression form to avoid false E0065 on multiline static_assert.
constexpr size_t MmapTileHeaderInitializedBytes =
    sizeof(MmapTileHeader::mmapMagic) +
    sizeof(MmapTileHeader::dtVersion) +
    sizeof(MmapTileHeader::mmapVersion) +
    sizeof(MmapTileHeader::size) +
    sizeof(MmapTileHeader::usesLiquids) +
    sizeof(MmapTileHeader::padding);
static_assert(sizeof(MmapTileHeader) == MmapTileHeaderInitializedBytes, "MmapTileHeader has uninitialized padding fields");
