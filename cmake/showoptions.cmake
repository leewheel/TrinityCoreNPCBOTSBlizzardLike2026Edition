...
if(WITH_NPCBOT_LLM_EMBED)
  if(WITH_NPCBOT_LLM_GPU)
    message("* NpcBot LLM embed       : Yes (llama.cpp + GGML_CUDA GPU)")
  else()
    message("* NpcBot LLM embed       : Yes (llama.cpp CPU-only)")
  endif()
else()
  message("* NpcBot LLM embed       : No")
endif()
